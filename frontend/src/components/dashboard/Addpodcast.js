...
export default function Addpodcast({ addpodcast, getaddpodcast }) {
  ...
  if (selectedCoverPic !== null) {
    formDataCover.append("mediaLink", selectedCoverPic, selectedCoverPic.name);
  }
  ...
  const uploadCover = () => {
    axios
      .post("/posts/content-upload", formDataCover)
      .then((res) => {
  ...
  const uploadMedia = () => {
    axios
      .post("/podcasts/content-upload", formDataContent)
      .then((res) => {
  ...
  const handleCreate = async () => {
    ...
    axios
      .patch(`/podcasts/add/${userid}`, data)
      .then((res) => {
        setSuccMsg("Podcast Created successfully!");
      })
      .catch((err) => {
